...
- Sprint plan: this `EPIC.md` + per-task `TASK.md` files under `ad/tickets/E-dvehbb-e2e-playground-tests/`.
- Reference epic (style + Area-1/2 behavior): `ad/tickets/E-v0f0c9-logging-dynamic-workflows/EPIC.md`.
