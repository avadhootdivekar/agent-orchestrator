...
| Role | File | Use for |
|------|------|---------|
| architect | `architect.md` | Full-epic design + sprint planning; writes tickets to `../meta/tickets/`. |
...
Epic/task work is tracked under [`../meta/tickets/`](../meta/tickets/) — follow the ID format and status-sync conventions in `../meta/tickets/README.md`.
