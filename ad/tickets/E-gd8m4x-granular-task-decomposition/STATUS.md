...
By: architect · Role: architect · Date: 2026-07-09 · Comment: Created from the user-ACCEPTED granular-task-decomposition HLD (2026-07-09). Cross-repo: instructions/scaffold in `ao-runner-finplan/workflows/epic-runner/`, framework enablers in `agent-orchestrator`. Depends on `E-rc7k2v` (nested-emission verification E1 + injection caps E2) and `E-st5p3q` (per-task model/effort E3). E4 token telemetry already exists.
